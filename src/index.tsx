...
app.get('/admin', (c) => {
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <script src="/static/app-v2.js?v=5"></script>
        <script src="/static/internal-links.js?v=5"></script>
        <script src="/static/image-library.js?v=5"></script>
        <script src="/static/user-management.js?v=5"></script>
    </body>
    </html>
  `)
})
